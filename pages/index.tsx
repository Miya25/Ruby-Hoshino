  ...
  return (
    <div className="flex max-w-5xl mx-auto flex-col items-center justify-center py-2 min-h-screen">
      <Head>
        ...
        <link rel="icon" href="https://cdn.topiclist.xyz/images/png/DiscordInflux_logo.png" />
      </Head>

      <Header />
      <main className="flex flex-1 w-full flex-col items-center justify-center text-center px-4 mt-12 sm:mt-20" style={{ backgroundColor: "#080b61" }}>
